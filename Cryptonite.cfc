<cfcomponent output="false" mixin="controller,model,dispatch,global">
...
<cffunction name="genBase64Salt" access="public" returnType="string" output="no">
...
--->
<cffunction name="genBinarySalt" access="public" returnType="binary" output="no">
    <cfargument name="size" type="numeric" required="true"/>
    <cfscript>
